...
// import { useNavigate } from 'react-router-dom';
// import { FaPaperclip, FaDownload } from 'react-icons/fa';
// import { formatDateTime } from '../../utils/helpers'; // updated import
// import api from '../../utils/api';
...
//       {/* Metadata: ticket no, date + time, attachments */}
//       <div className="flex items-center justify-between mt-3 text-sm text-gray-500">
//         <div className="flex items-center gap-3">
//           <span>{ticket.ticketNumber}</span>
//           <span>•</span>
//           <span>{formatDateTime(ticket.createdAt)}</span> {/* Updated here */}
//           {ticket.attachments?.length > 0 && (
//             <>
//               <span>•</span>
//               <span className="flex items-center gap-1">
...
//       {/* Creator Info (for admin & employee) */}
//       {(userRole === 'admin' || userRole === 'employee') && ticket.user && renderUserCard(ticket.user, 'User')}
